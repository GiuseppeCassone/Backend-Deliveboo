    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card personal_color3 animate__animated animate__fadeIn">
                <div class="card-header text-light text-center fw-bold fs-4">{{ __('Diventa collaboratore di WOW Delive, non te ne pentirai!') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('register') }}">
                        ...
                        <div class="mb-4 row">
                            <label for="password-confirm" class="col-md-4 text-light col-form-label text-md-right">{{ __('Conferma la password') }}</label>
                        ...
                        <div class="mb-4 row">
                            <label for="img" class="col-md-4 col-form-label text-light text-md-right">{{ __('Immagine del ristorante') }}</label>
                        ...
                        <div class="mb-4 row">
                            <label for="description" class="col-md-4 text-light col-form-label text-md-right">{{ __('Descrizione del ristorante') }}</label>
                        ...
                        <div class="mb-4 row">
                            <label for="phone_number" class="col-md-4 text-light col-form-label text-md-right">{{ __('Numero di telefono') }}</label>

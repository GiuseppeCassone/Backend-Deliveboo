    ...
    <div class="card personal_color3 animate__animated animate__fadeIn w-50">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-4 row">
                    <label for="email" class="col-md-4 text-light col-form-label text-md-right">{{ __('Indirizzo E-Mail') }}</label>
                ...
                <div class="mb-4 row">
                    <label for="password" class="col-md-4 text-light col-form-label text-md-right">{{ __('Password') }}</label>
